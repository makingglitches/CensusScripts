...
int main()
{
    // so maybe we do somenthing different now :P
    // since nothing changes stupid lol
    ...
    GDALDatasetH  g = GDALOpen(filename, GA_ReadOnly);

}

// ryan he says. awful jackass still.
// they just gotta keep on trying to make time stand still
// why ?
